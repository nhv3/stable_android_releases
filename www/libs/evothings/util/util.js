...
;(function()
{
	...
	//Function made for signed 32 bit integers because we need to make sure that the signed ppg readings are converted correctly
	evothings.util.littleEndianToInt32 = function(data, offset)
	{
		return (evothings.util.littleEndianToInt8(data, offset + 3) << 24) +
			(evothings.util.littleEndianToInt8(data, offset + 2) << 16) +
			(evothings.util.littleEndianToInt8(data, offset + 1) << 8) +
			evothings.util.littleEndianToInt8(data, offset)
	}
